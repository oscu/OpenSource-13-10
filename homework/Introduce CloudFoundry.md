Cloud Foundry的是一个开放的平台即服务(PaaS)，它提供可选择的云、开发框架和应用服务。 Cloud Foundry可以使构建、测试、部署规模化的应用程序变得更快，更容易。Cloud Foundry是一个开源项目，可以分布各种私有云和实例化公共云。 Cloud Foundry由Pivotal公司及其合作伙伴提供服务。
